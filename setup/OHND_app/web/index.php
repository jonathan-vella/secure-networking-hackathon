...
<html lang="en">
    ...
    <body>
        <div class="header">
			<div class="container">
            <p style="text-align:center;"><img src="hackathonLogoTP.png" alt="hackathon logo" width="80%"></p>
				<h1 class="header-heading">hackathon Network Diagnostics</h1>
			</div>
		</div>
		<div class="nav-bar">
			<div class="container">
                ...
                <li><a href="index.php">Home</a></li>
                    ...
                    <li><a hef="https://hackathon.microsoft.com/">Microsoft hackathons</a></li>
